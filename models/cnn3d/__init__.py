...
class C3D(nn.Module):
    def __init__(self,
        ...
        self.group1 = nn.Sequential(
            nn.Conv3d(3, 9, kernel_size=3, padding=1),
            nn.BatchNorm3d(9),
            nn.ReLU(),
            nn.MaxPool3d(kernel_size=(2, 2, 2), stride=(1, 2, 2)))
        self.group2 = nn.Sequential(
            nn.Conv3d(9, 12, kernel_size=3, padding=1),
            nn.BatchNorm3d(12),
            nn.ReLU(),
        ...
        self.group4 = nn.Sequential(
            nn.Conv3d(12, 16, kernel_size=3, padding=1),
            nn.BatchNorm3d(16),
            nn.ReLU(),
        ...
        self.fc1 = nn.Sequential(
            nn.Linear((16 * last_duration * last_size * last_size), 4096),
            nn.ReLU(),
            nn.Dropout(0.5))
